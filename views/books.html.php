...
<div class="max-w-5xl mx-auto px-3">
        ...
        <div class="text-center mb-8">
            <a class="bg-gray-900 px-4 py-2 text-white inline-block rounded hover:bg-gray-700 duration-200" href="/book/creer">
                Créer un livre
            </a>
        </div>
                        ...
                        <a href="book/<?= $book['id']; ?>">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex justify-around items-center">
                                    <p class="text-lg font-bold"><?= BooksController::price($book['price'], $book['discount']); ?>€</p>
                                    <?php if($book['discount'] > 0){ ?>
                                    <p class="text-xs font-bold">-<?= $book['discount']; ?>% <span class="line-through"><?= BooksController::price($book['price']); ?>€</span></p>
                                <?php } ?>
                                </div>
